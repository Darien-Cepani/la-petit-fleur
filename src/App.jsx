...
const BRAND = {
  name: "LA PETIT FLEUR",
  wordmark: "La Petit Fleur",
  handle: "la.petit.fleur",
  instagram: "https://instagram.com/la.petit.fleur",
  phone: "+355 69 405 1234",
  phoneHref: "+355694051234",
  email: "hello@lapetitfleur.al",
...
const LANG = {
  en: {
    ...
    hero: {
      eyebrow: "Floral Design & Event Styling in Tirana",
    ...
    visit: {
      ...
      body: "Step into La Petit Fleur to choose your blooms in person, or commission bespoke florals for your wedding or event. Our designers are always happy to help you craft something unforgettable.",
    ...
    toast: {
      ...
      newsletter: "Welcome to La Petit Fleur! 💐",
      booking: "To plan your event florals, please call +355 69 405 1234."
    }
  },
  sq: {
    tagline: "LULE & EVENTE",
    ...
    hero: {
      eyebrow: "Dizajn Floreal & Stilizim Eventesh në Tiranë",
    ...
    visit: {
      ...
      body: "Hyni në La Petit Fleur për të zgjedhur lulet personalisht, ose porosisni dekor floreal sipas porosisë për dasmën apo eventin tuaj. Dizajnerët tanë janë gjithmonë të gatshëm t'ju ndihmojnë të krijoni diçka të paharrueshme.",
    ...
    toast: {
      ...
      newsletter: "Mirë se vini te La Petit Fleur! 💐",
      booking: "Për të planifikuar lulet e eventit, ju lutemi telefononi +355 69 405 1234."
    }
  }
};
...
const PRODUCTS = [
  {
    id: 1,
    name: { en: "Sage & Amber Tablescape", sq: "Tavolinë me Sherebelë & Qelibar" },
    category: "weddings",
    image: "ig/ig01.jpg",
    description: {
      en: "An intimate event tablescape styled with clusters of green hydrangea and warm amber roses scattered across charger plates, candlelight, and a moody dark linen.",
      sq: "Një tavolinë eventi e stilizuar me tufa hortensie të gjelbra dhe trëndafila qelibar të ngrohtë, të shpërndarë mbi pjata, qirinj dhe një mbulesë të errët elegante."
    },
    details: {
      en: ["Bespoke event styling", "Green & amber autumn palette", "Delivered & styled on-site"],
      sq: ["Stilizim eventi sipas porosisë", "Paletë vjeshte e gjelbër & qelibar", "E dorëzuar & e stilizuar në vend"]
    }
  },
  {
    id: 2,
    name: { en: "Blush Garden Rose Bouquet", sq: "Buqetë me Trëndafila Kopshti Rozë" },
    category: "bouquets",
    image: "ig/ig02.jpg",
    description: {
      en: "A lush hand-tied dome of blush and mauve garden roses with a single peach ranunculus, in the softest powder-pink and ivory tones.",
      sq: "Një buqetë e harlisur e punuar me dorë me trëndafila kopshti rozë dhe lejla, me një ranunkulus pjeshke, në tone rozë pudër dhe fildishtë të buta."
    },
    details: {
      en: ["Hand-tied to order", "Blush, mauve & ivory palette", "Ideal for romantic gestures"],
      sq: ["Punuar me dorë me porosi", "Paletë rozë, lejla & fildishtë", "Ideale për gjeste romantike"]
    }
  },
  {
    id: 3,
    name: { en: "Pink Tulip & Eucalyptus Bouquet", sq: "Buqetë me Tulipanë Rozë & Eukalipt" },
    category: "bouquets",
    image: "ig/ig03.jpg",
    description: {
      en: "A relaxed spring gathering of soft pink tulips threaded with silvery eucalyptus, wrapped in natural kraft and tissue.",
      sq: "Një buqetë pranverore e qetë me tulipanë rozë të butë të ndërthurur me eukalipt argjendi, e mbështjellë me letër kraft natyrale."
    },
    details: {
      en: ["Seasonal spring tulips", "Pink & sage-green palette", "Casual, just-picked style"],
      sq: ["Tulipanë sezonalë pranvere", "Paletë rozë & gjelbërim sage", "Stil i lirshëm, sapo i mbledhur"]
    }
  },
  {
    id: 4,
    name: { en: "Red Romance Rose Bouquet", sq: "Buqetë me Trëndafila të Kuq Romantikë" },
    category: "roses",
    image: "ig/ig04.jpg",
    description: {
      en: "A timeless declaration of deep velvet-red roses framed with eucalyptus, wrapped in burgundy paper and finished with a flowing satin ribbon.",
      sq: "Një deklaratë e përjetshme me trëndafila të kuq kadife të kornizuar me eukalipt, të mbështjellë me letër bordo dhe të përfunduar me një fjongo satini."
    },
    details: {
      en: ["Premium long-stem red roses", "Available in 25 / 50 / 101 stems", "Perfect for anniversaries"],
      sq: ["Trëndafila premium me kërcell të gjatë", "25 / 50 / 101 kërcej", "Ideale për përvjetorë"]
    }
  },
  {
    id: 5,
    name: { en: "Coral Rose Garden Vase", sq: "Vazo me Trëndafila Kopshti Koral" },
    category: "arrangements",
    image: "ig/ig05.jpg",
    description: {
      en: "A romantic vase arrangement of coral and peach garden roses accented with dark seed-pod textures, styled for a tall, painterly silhouette.",
      sq: "Një kompozim romantik në vazo me trëndafila kopshti koral dhe pjeshke, të theksuar me tekstura të errëta, të stilizuar në një siluetë të gjatë artistike."
    },
    details: {
      en: ["Arranged in a glass vase", "Coral & peach palette", "Statement piece for the home"],
      sq: ["I rregulluar në vazo qelqi", "Paletë koral & pjeshke", "Pjesë statement për shtëpinë"]
    }
  },
  {
    id: 6,
    name: { en: "Pastel Bloom Hat Box", sq: "Kuti me Lule Pastel" },
    category: "arrangements",
    image: "ig/ig06.jpg",
    description: {
      en: "A signature round hat box brimming with pastel peonies, blush roses, spray roses, and cream tulips — a soft, sculptural gift that needs no vase.",
      sq: "Një kuti e rrumbullakët me firmë, plot me bozhure pastel, trëndafila rozë dhe tulipanë krem — një dhuratë e butë skulpturore që nuk kërkon vazo."
    },
    details: {
      en: ["Signature round flower box", "Soft pastel mixed blooms", "Ready to gift, no vase needed"],
      sq: ["Kuti e rrumbullakët me firmë", "Lule të përziera pastel të buta", "Gati për dhuratë, pa vazo"]
    }
  },
  {
    id: 7,
    name: { en: "Coral Peach Rose Bouquet", sq: "Buqetë me Trëndafila Koral & Pjeshkë" },
    category: "roses",
    image: "ig/ig07.jpg",
    description: {
      en: "A full hand-tied bouquet of warm coral-peach roses with delicate accents, wrapped in rich terracotta paper for a glowing, sunset feel.",
      sq: "Një buqetë e plotë e punuar me dorë me trëndafila koral-pjeshke të ngrohtë me detaje delikate, e mbështjellë me letër terrakota për një ndjesi perëndimi dielli."
    },
    details: {
      en: ["Hand-tied to order", "Warm coral & peach roses", "Wrapped in terracotta paper"],
      sq: ["Punuar me dorë me porosi", "Trëndafila të ngrohtë koral & pjeshke", "I mbështjellë me letër terrakota"]
    }
  },
  {
    id: 8,
    name: { en: "Pure White Rose Bouquet", sq: "Buqetë me Trëndafila Krejt të Bardhë" },
    category: "roses",
    image: "ig/ig08.jpg",
    description: {
      en: "An elegant hand-tied bouquet of pure white roses with wisps of fresh greenery, wrapped in soft blush paper — clean, classic, and timeless.",
      sq: "Një buqetë elegante e punuar me dorë me trëndafila krejt të bardhë dhe gjelbërim të freskët, e mbështjellë me letër rozë të butë — e pastër, klasike dhe e përjetshme."
    },
    details: {
      en: ["Hand-tied white roses", "Crisp white & green palette", "Perfect for weddings & sympathy"],
      sq: ["Trëndafila të bardhë me dorë", "Paletë e bardhë & e gjelbër", "Ideale për dasma & ngushëllime"]
    }
  }
];

// Logo mark — La Petit Fleur's real vector logo (Brand/logo.svg) rendered as a
// CSS mask so it inherits `currentColor`. That makes it white over the dark
// hero / splash / footer and dark on the light mobile menu, with no white box.
...
export default function App() {
  ...
  useEffect(() => {
    ...
    document.title = lang === "sq"
      ? "La Petit Fleur — Dizajn Floreal & Stilizim Eventesh në Tiranë"
      : "La Petit Fleur — Floral Design & Event Styling in Tirana";
  }, [lang]);
  ...
  return (
    <div ref={containerRef} className="relative min-h-screen font-sans antialiased text-brand-dark selection:bg-brand-gold/25 selection:text-brand-dark md:select-none bg-white overflow-x-hidden">
      ...
      >
        <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(circle at 50% 42%, rgba(201,149,107,0.16), transparent 58%)' }} />
        ...
        <div className="splash-inner relative text-center px-6">
          <LogoMark className="splash-mark h-24 sm:h-28 w-[20rem] sm:w-[24rem] mx-auto mb-8 text-white" />
          <div className="loader-line h-px w-0 mx-auto mt-2 bg-gradient-to-r from-transparent via-brand-gold to-transparent" />
      ...
      >
        ...
        <div className="lg:hidden flex items-center justify-between">
          <a href="#" onClick={() => setMobileMenuOpen(false)} className="flex items-center group leading-none">
            <LogoMark className="h-[3.6rem] w-[11rem]" />
          </a>
          <button
        ...
        <div className="hidden lg:grid grid-cols-3 items-center">
          ...
          <a
            ...
            onMouseLeave={() => triggerCursor("", false)}
            className="justify-self-center group leading-none"
          >
            <LogoMark className="h-[4.55rem] w-[14.3rem] transition-transform duration-500 group-hover:scale-105" />
          </a>
          ...
          <div className="flex items-center justify-end gap-5">
            ...
            <a
              ...
              onMouseLeave={() => triggerCursor("", false)}
              className="flex items-center gap-1.5 bg-white text-brand-dark hover:bg-brand-deep hover:text-white transition-colors duration-300 rounded-full px-5 py-2.5 text-[10px] font-display tracking-[0.2em] uppercase font-semibold"
            >
      ...
      >
        <div className="flex items-center justify-between px-6 py-5 border-b border-brand-champagne">
          <div className="flex items-center">
            <LogoMark className="h-11 w-[8.5rem] text-brand-dark" />
          </div>
        ...
        <div className="px-6 py-6 border-t border-brand-champagne flex flex-col gap-5">
          <a
            href="#showroom-consultations"
            onClick={() => setMobileMenuOpen(false)}
            className="w-full text-center bg-brand-dark text-white hover:bg-brand-deep transition-colors py-4 rounded-full text-[11px] font-display uppercase tracking-[0.22em] font-semibold"
          >
            {t.nav.book}
          </a>
      ...
      <section className="relative h-[100svh] min-h-[560px] overflow-hidden hero-section bg-brand-night text-white">
        ...
        >
          <source src="https://videos.pexels.com/video-files/1344337/1344337-hd_1920_1080_30fps.mp4" type="video/mp4" />
        </video>
          ...
          <div className="overflow-hidden mt-7 sm:mt-9 w-full">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 hero-animate">
              <a
                ...
                onMouseLeave={() => triggerCursor("", false)}
                className="w-full sm:w-auto inline-flex items-center justify-center gap-3 text-xs tracking-[0.25em] uppercase font-display bg-brand-gold text-brand-night hover:bg-white px-7 py-4 rounded-full transition-all duration-300 font-semibold"
              >
              ...
              <a
                ...
                onMouseLeave={() => triggerCursor("", false)}
                className="w-full sm:w-auto inline-flex items-center justify-center gap-3 text-xs tracking-[0.25em] uppercase font-display border border-white/40 bg-white/10 backdrop-blur-md hover:bg-white hover:text-brand-night px-7 py-4 rounded-full transition-all duration-300 text-white"
              >
                {t.hero.ctaSecondary}
              </a>
            </div>
      ...
      <section className="pb-20 sm:pb-24 px-5 sm:px-4 md:px-12 max-w-7xl mx-auto bg-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5 sm:gap-6 md:gap-8">
          {[
            { span: "md:col-span-7", cat: "bouquets", img: "ig/ig11.jpg", cursor: "BOUQUETS" },
            { span: "md:col-span-5", cat: "roses", img: "ig/ig12.jpg", cursor: "ROSES" },
            { span: "md:col-span-5", cat: "arrangements", img: "ig/ig09.jpg", cursor: "ARRANGEMENTS" },
            { span: "md:col-span-7", cat: "weddings", img: "ig/ig01.jpg", cursor: "WEDDINGS" }
          ].map((c, i) => (
            <div
              key={c.cat}
              className={`${c.span} relative h-[320px] sm:h-[380px] md:h-[500px] overflow-hidden rounded-3xl collection-card bg-brand-champagne group cursor-pointer border border-brand-champagne shadow-sm animate-fade-in`}
              onClick={() => {
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-4 md:px-12">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-x-4 sm:gap-x-8 gap-y-10 sm:gap-y-16">
            {filteredProducts.map((product) => (
              ...
              >
                <div className="relative aspect-[3/4] overflow-hidden rounded-2xl bg-brand-champagne border border-brand-champagne transition-all duration-500 shadow-sm group-hover:shadow-md">
                  <img
                    src={product.image}
        ...
        <div className="relative z-10 max-w-2xl mx-auto px-6">
          ...
          <div className="mt-9 sm:mt-10 flex justify-center">
            <button
              ...
              className="w-full sm:w-auto px-8 py-4 bg-brand-gold hover:bg-white text-brand-night text-xs tracking-[0.25em] font-display uppercase rounded-full transition-all duration-500 shadow-xl font-semibold"
            >
              {t.consult.cta}
            </button>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-4 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col gap-4">
            ...
            <div className="relative w-full h-[300px] sm:h-[350px] md:h-[450px] bg-brand-champagne border border-brand-champagne shadow-md overflow-hidden mt-4">
              <div id="map" role="img" aria-label="Map showing La Petit Fleur in Tirana" className="w-full h-full absolute inset-0 z-10 desaturate-map" />
      ...
      <section className="py-20 sm:py-24 max-w-7xl mx-auto px-5 sm:px-4 md:px-12 bg-white">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
          {[
            ...
            <a key={i} href={BRAND.instagram} target="_blank" rel="noreferrer" className="block relative aspect-square overflow-hidden group rounded-2xl bg-brand-champagne border border-brand-champagne">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 pb-12 sm:pb-16 border-b border-white/10">
            <div className="lg:col-span-7">
              <div className="flex flex-col items-start">
                <LogoMark className="h-14 w-[11rem] text-white mb-4" />
                <span className="text-[8px] tracking-[0.5em] text-brand-gold uppercase block mt-1 font-bold">{t.tagline}</span>
              </div>
      ...
      {selectedProduct && (
        <div className="fixed inset-0 z-[150] flex items-center justify-center p-3 sm:p-4">
          ...
          <div className="relative bg-white w-full max-w-4xl max-h-[92vh] overflow-y-auto no-scrollbar rounded-3xl shadow-2xl border border-brand-champagne grid grid-cols-1 md:grid-cols-12 z-10 animate-scale-up">
